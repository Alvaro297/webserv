...
class FillResp
{
	public:
		...
		static void	set403(Response &res, const Request &req) {
			res.setStatus(403, "Forbidden");
			res.setHeader("Content-Type", req.getType());
			res.setBody("<h1>403 Forbidden</h1>");
		}

		static void	set404(Response &res, const Request &req) {
			res.setStatus(404, "Not Found");
			res.setHeader("Content-Type", req.getType());
			res.setBody("<h1>404 Not Found</h1>");
		}

		static void	set405(Response &res, const Request &req) {
			res.setStatus(405, "Method Not Allowed");
			res.setHeader("Content-Type", req.getType());
			res.setBody("<h1>405 Method Not Allowed</h1>");
		}

		static void	set500(Response &res, const Request &req) {
